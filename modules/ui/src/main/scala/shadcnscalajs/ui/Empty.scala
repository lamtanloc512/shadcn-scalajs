...
object Empty:
  def apply(mods: Modifier[HtmlElement]*): HtmlElement =
    div(
      cls := "flex min-h-40 w-full flex-col items-center justify-center gap-6 rounded-lg border border-dashed p-6 text-center",
      mods
    )
  def header(mods: Modifier[HtmlElement]*): HtmlElement =
    div(cls := "flex max-w-sm flex-col items-center gap-2 text-center", mods)
