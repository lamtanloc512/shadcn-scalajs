import basecoatRuntimeSource from "../../../../src/js/basecoat.js?raw"
import chartRuntimeSource from "../../../../src/js/chart.js?raw"
import chartExamplesSource from "../../scripts/chart-examples.js?raw"
